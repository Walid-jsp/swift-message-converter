...
import { CheckCircle2, AlertCircle, Upload, Trash2, RefreshCw, FileText } from "lucide-react"

export default function ValidateMT({ backendStatus, onAddToHistory, onRefreshHistory }) {
  ...
  const handleValidate = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        onAddToHistory(message.trim(), null, "VALIDATION", [], [], result.errors)
          ...
          <CardContent>
            {validationResult.errors.length === 0 ? (
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h4 className="font-medium mb-2">Liste des erreurs :</h4>
